...
Passionate Data Analyst and AI Developer with expertise in transforming complex datasets into actionable business insights. Certified in Microsoft Azure with strong skills in Python, SQL, Power BI, and machine learning. Committed to building scalable, data-driven solutions that optimize decision-making and drive measurable business growth.
...
| **Data Science** | **Business Intelligence** | **Software Engineering** | **Cloud Engineering** |
|-----------------|--------------------------|-------------------------|----------------------|
| ![Python](https://img.shields.io/badge/Python-Expert-3776AB?logo=python&logoColor=white) | ![Power BI](https://img.shields.io/badge/Power_BI-Expert-F2C811?logo=powerbi&logoColor=black) | ![Java](https://img.shields.io/badge/Java-Advanced-007396?logo=java&logoColor=white) | ![Azure](https://img.shields.io/badge/Azure-Certified-0089D6?logo=microsoftazure&logoColor=white) |
| ![Pandas](https://img.shields.io/badge/Pandas-Expert-150458?logo=pandas&logoColor=white) | ![Tableau](https://img.shields.io/badge/Tableau-Advanced-E97627?logo=tableau&logoColor=white) | ![JavaScript](https://img.shields.io/badge/JavaScript-Advanced-F7DF1E?logo=javascript&logoColor=black) | ![Docker](https://img.shields.io/badge/Docker-Advanced-2496ED?logo=docker&logoColor=white) |
| ![NumPy](https://img.shields.io/badge/NumPy-Expert-013243?logo=numpy&logoColor=white) | ![Excel](https://img.shields.io/badge/Excel-Expert-217346?logo=microsoftexcel&logoColor=white) | ![Git](https://img.shields.io/badge/Git-Expert-F05032?logo=git&logoColor=white) | ![Kubernetes](https://img.shields.io/badge/K8s-Intermediate-326CE5?logo=kubernetes&logoColor=white) |
| ![SQL](https://img.shields.io/badge/SQL-Expert-4479A1?logo=postgresql&logoColor=white) | ![Data Modeling](https://img.shields.io/badge/Data_Modeling-Advanced-FF6B6B) | ![CI/CD](https://img.shields.io/badge/CI/CD-Advanced-2088FF?logo=githubactions&logoColor=white) | ![Terraform](https://img.shields.io/badge/Terraform-Intermediate-7B42BC?logo=terraform&logoColor=white) |
...
### **365 Data Science Specializations**
<div align="center">
  
| Certification | Focus Area | Status |
|---------------|------------|--------|
| **Mastering SQL** | Database Management | ✅ Completed |
| **Mastering Key Performance Indicators (KPIs)** | Business Intelligence | ✅ Completed |
| **Data Analysis in Power BI with ChatGPT** | AI-enhanced Analytics | ✅ Completed |
...
![Transact-SQL](https://img.shields.io/badge/Transact_SQL-Programming-Fuchsia)
![MLflow](https://img.shields.io/badge/MLflow-Model_Tracking-0194E2)
![AutoML](https://img.shields.io/badge/AutoML-Model_Selection-FF6B6B)
![AI Document Intelligence](https://img.shields.io/badge/AI_Document_Intelligence-4CAF50)
![Computer Vision](https://img.shields.io/badge/Computer_Vision-9C27B0)
![Speech Recognition](https://img.shields.io/badge/Speech_Recognition-FF9800)
![NLP](https://img.shields.io/badge/NLP-3F51B5)
![Generative AI](https://img.shields.io/badge/Generative_AI-FF5722)
![Machine Learning](https://img.shields.io/badge/Machine_Learning-00BCD4)
![Azure Monitoring](https://img.shields.io/badge/Azure_Monitoring-0078D4)
![Cost Management](https://img.shields.io/badge/Cost_Management-5D2E8C)
![Cloud Computing](https://img.shields.io/badge/Cloud_Computing-2196F3)
![Process Mining](https://img.shields.io/badge/Process_Mining-742774)
...
- **Data Cleaning & Preprocessing** – Ensuring data quality and reliability
- **Exploratory Data Analysis (EDA)** – Uncovering patterns and insights
- **KPI Development & Tracking** – Measuring business performance
...
- **ML Operations** – Model deployment and lifecycle management

### **Data Engineering & DevOps**
- **ETL/ELT Pipelines** – Building robust data workflows
- **Data Modeling** – Designing efficient database structures
- **API Integrations** – Connecting diverse data sources
- **CI/CD Pipelines** – Automated deployments with Docker & Kubernetes
- **Cloud Infrastructure** – Azure services and Terraform
...
def predict_property_value(location, features, market_trends):
    ...
    Integrates Azure ML for model management
    """
    model = load_optimized_model('azureml://real-estate-model')
...
- Real-time sales performance tracking using Power BI
...
- Dynamic visualization creation based on user intent
- Automated PDF report generation

**Tech Stack**: 
![Azure OpenAI](https://img.shields.io/badge/-Azure_OpenAI-0089D6?logo=microsoftazure&logoColor=white)
...
| **Technical Excellence** | **Business Impact** | **Continuous Growth** |
|-------------------------|---------------------|----------------------|
| • Clean, efficient code<br>• Scalable architecture<br>• Best practices | • Data-driven decisions<br>• ROI-focused solutions<br>• Stakeholder alignment | • Latest technologies<br>• Certifications<br>• Skill enhancement |
...
- **Software Engineering Principles** – Clean Code, Design Patterns, Testing
- **Microsoft Azure Certified** – Cloud, Data, and AI specializations
- **365 Data Science Programs** – Advanced analytics and BI training
- **DevSecOps Practices** – Secure development lifecycle
...
[![Email](https://img.shields.io/badge/📧_Email_Me-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:bourzguifatimzahra@gmail.com)
[![LinkedIn](https://img.shields.io/badge/💼_LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/Bourzguifatimazahra)
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-FF7139?style=for-the-badge&logo=firefox&logoColor=white)](https://fzbourzgui.netlify.app)
